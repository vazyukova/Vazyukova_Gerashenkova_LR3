...
if __name__ == '__main__':
    ...
    #img = 'D:\\Магистратура\\1 семестр\\ПИС\\Image-Captioning\\data\\Images\\95728660_d47de66544.jpg'
    # img = 'D:\\Магистратура\\1 семестр\\ПИС\\Image-Captioning\\data\\Images\\109202756_b97fcdc62c.jpg'
    img = 'test\\guy-man-male-play-football-soccer-kick-ball-park.jpg'
    wordmap_path = 'data/output/wordmap_flickr8k.json'
    beam_size = 5
    ifsmooth = False
